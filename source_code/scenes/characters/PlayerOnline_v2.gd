...
# (4) Emits Player Movement Update to Peers on every input button press
#
# Contains
...
# (10) Implement Message Pack for 50% data packet compression
# (11) Implement Websocket Multiplayer
