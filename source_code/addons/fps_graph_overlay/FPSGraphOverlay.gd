...
@export var point_interval_seconds: float: float = 1
@export var points_on_screen: int: int = 120
@export var max_fps: int: int = 60
@export var enable_f12_shortcut: bool: bool = true
