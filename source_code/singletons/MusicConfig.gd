...
@export var play_back_position : int
@export var track_length : int

@export var music_track : String

@export var default_playlist : Dictionary = {
...
@export var comic_sfx : Dictionary = {
...
@export var ui_sfx : Dictionary = {
	0:'res://sounds/Menu1A.ogg',
	1:'res://sounds/Menu1B.ogg',
}


@export var item_use_sfx : Dictionary = {
	0: "res://sounds/item_collected.ogg"
}

@export var blood_fx : Dictionary = {
	0 :"res://sounds/blood-spilling.ogg" 
}

@export var hit_sfx : Dictionary = {
...
@export var grass_sfx : Dictionary  = {0:'res://sounds/Fantozzi-SandR3.ogg'}

@export var wind_sfx : Dictionary = {
	0:'res://sounds/wind_2.ogg',
	1: 'res://sounds/gogeta-gogeta-instant-teleportation-sound-effect.ogg'
	}


@export var sword_sfx : Dictionary = {
...
@export var nokia_soundpack : Dictionary = {
