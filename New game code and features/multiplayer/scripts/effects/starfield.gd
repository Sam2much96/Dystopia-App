...
# Alter code to render sand dust instead 
...
func _process(_delta):
	...
	if previous_position == null:
		previous_position = Vector2()#node_camera.offset #code line returns null
		pass
	var diff =  previous_position -  Vector2()#node_camera.offset
	previous_position = null #node_camera.offset
