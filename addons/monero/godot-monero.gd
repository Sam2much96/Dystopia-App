...
onready var lib_monero = preload("res://addons/monero/monero.gdns").new() #calls the library files
#// create a wallet from a mnemonic phrase
var mnemonic = "hefty value later extra artistic firm radar yodel talent future fungal nutshell because sanity awesome nail unjustly rage unafraid cedar delayed thumbs comb custom sanity";
var monero_wallet
var wallet_restored
#var monero_wallet_full #moner wallet full address, i presume
