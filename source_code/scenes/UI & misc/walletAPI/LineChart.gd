...
# The function of this code is to fetch historical price data from
# vestige api of my asa and draw the price action using godot's line 2d
# this code is untested as at October 10/2025
# documentations :
# (1) github: https://github.com/Iaknihs/tutorials/blob/master/Godot_Line_Chart/line_chart.gd
# (2) vestige: https://api.vestigelabs.org/docs#/

# to do:
# (1) test code implementation
# (2) Port engine monitor logic to change the line colour from green to red and vice versa
