...
func _ready():
	...
	RestHandler_.connect("invitation_accepted", Callable(self, "_on_invitation_accepted"))
	RestHandler_.connect("invitation_declined", Callable(self, "_on_invitation_declined"))
