...
class_name AdMob, "res://ads/admob-lib/icon.png"
...
func _enter_tree():
	if not init():
		push_error("AdMob Java Singleton not found. This plugin will only work on Android")
		emit_signal("init_failed")
...
func init() -> bool:
	if(Engine.has_singleton("GodotAdMob")):
		...
		Networking._admob_singleton = _admob_singleton #Updates to singleton
